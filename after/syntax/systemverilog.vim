...
syn keyword uvmMethod            accept_tr all_dropped apply_config_settings begin_child_tr begin_tr build build_phase
syn keyword uvmMethod            check clone check_config_usage check_phase configure_phase connect_phase
...
syn keyword uvmMethod            end_tr extract extract_phase final_phase flus get_child get_config_int get_config_object get_config_sring
syn keyword uvmMethod            get_first_child get_full_name get_next_child get_num_children get_parent has_child
syn keyword uvmMethod            kill lookup main_phase masage_scope m_begin_tr print_config_settings print_override_info record_error_tr
syn keyword uvmMethod            phase_ended phase_ready_to_end phase_started post_configure_phase post_main_phase post_reset_phase
syn keyword uvmMethod            post_shutdown_phase pre_abort pre_configure_phase 
syn keyword uvmMethod            pre_main_phase pre_reset_phase pre_shutdown_phase raised 
syn keyword uvmMethod            record_event_tr report report_phaseresolve_bindings restart resume reset_phase run run_phase set_config_int set_config_object
...
syn keyword uvmMethod            shutdown_phase 
...
syn keyword uvmClass             uvm_phase_type uvm_phase_state
syn keyword uvmMethod            get_phase_type get_state get_run_count
syn keyword uvmMethod            find_by_name find is is_before is_after exec_func exec_task add
syn keyword uvmMethod            sync unsync wait_for_state jump jump_all get_jump_target
